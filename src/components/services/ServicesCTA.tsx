      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.div className="relative" variants={itemVariants}>
            ...
            >
              Besoin d&apos;aide pour choisir la solution adaptée à vos besoins ?
            </motion.h3>
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Nos experts sont à votre disposition pour vous conseiller et vous orienter vers 
            <span className="text-blue-700 font-medium"> les meilleures solutions d&apos;assurance </span> 
          ...
          >
            <div className="bg-white px-4 py-1.5 rounded-full shadow-md border border-blue-100 flex items-center space-x-2">
              ...
              <span className="text-xs text-blue-800 font-medium">Sécurisé et confidentiel</span>
            </div>
          </motion.div>
        </motion.div>
      </div>
